...
@view_defaults(context=FolderTranslationEntity)
class FolderTranslationCRUD(ContentTranslationCRUD):
    ...
    @view_config(
        context=FolderTranslationManager,
        request_method='POST',
        renderer='amnesia:templates/folder/edit.pt',
        permission='manage_translations'
    )
